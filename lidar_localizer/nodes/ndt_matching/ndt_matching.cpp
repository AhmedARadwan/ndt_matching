...
static void points_callback(const sensor_msgs::PointCloud2::ConstPtr& input)
{
  ...
  if (map_loaded == 1 && init_pos_set == 1)
  {
    ...
    */
    ...
    // // 1.2 0 2.0 0 0 0 1
    // transform_velodyne.setOrigin(tf::Vector3(1.2, 0, 2));
    // tf::Quaternion q;
    // q.setRPY(0, 0, 0);
    // transform_velodyne.setRotation(q);
    // br_velodyne.sendTransform(tf::StampedTransform(transform_velodyne, current_scan_time, "/base_link", "/velodyne"));
